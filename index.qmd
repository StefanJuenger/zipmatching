...
# Combine the two plots using patchwork
(map1 | map2) + plot_layout(guides = "collect", ncol = 2) +
  plot_annotation(title = "Accuracy of Centroid Linking")

centroid_map <- (map1 | map2) + plot_layout(guides = "collect") +
  plot_annotation(title = "Accuracy of Centroid Linking")
 
ggsave("./test/centroid_map.png", centroid_map, dpi = 300, width = 8, height = 6, units = "in")

```
<<<<<<< HEAD

![TestAbbildung](./test/centroid_map.png)

=======
>>>>>>> c07a8d3e4a75db03c42dfe56cc7338215389fb07
...
ggplot() +
  ...
  geom_sf(data = zip_code1, aes(fill = factor("ZIP Code", levels = desired_order2)), alpha = 0.8, color = "black") +      # Color for ZIP Code
   geom_sf_pattern(data = overlap, aes(fill = factor("Overlap", levels = desired_order2)), 
...
ggplot() +
  geom_sf(data = municipality1, aes(fill = factor("Municipality 1", levels = desired_order3)), 
          alpha = 0.3, color = "black") +  # Color for Municipality 1
  geom_sf(data = municipality2, aes(fill = factor("Municipality 2", levels = desired_order3)), 
          alpha = 0.3, color = "black") +  # Color for Municipality 2
  geom_sf(data = zip_code, aes(fill = factor("ZIP Code", levels = desired_order3)), 
          alpha = 0.7, color = "black") +  # Color for ZIP Code
  geom_sf_pattern(data = interpolated_municipality1, aes(fill = factor("Shares Municipality 1", levels = desired_order3)), 
  ...
  geom_sf_pattern(data = interpolated_municipality2, aes(fill = factor("Shares Municipality 2", levels = desired_order3)), 
