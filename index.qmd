...
If you have several variables of interest, you need to perform the areal interpolation seperately or create a function to loop over several columns. 
...
areal_interpolation_matched2 <- sf::st_interpolate_aw(
...
These calculations are stored as new variables, each labeled with the corresponding matching comparison type.
...
linked_survey <-
  ...
  dplyr::left_join(areal_interpolation_matched2 |>
                     sf::st_drop_geometry() |>
                     dplyr::select(-inhabitants_zip_code), by = "zip_code") |>
  # Rename columns for clarity
